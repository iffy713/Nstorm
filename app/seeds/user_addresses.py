...
def seed_user_addresses():
    address1 = UserAddress(
        user_id=1, address_id=1, is_primary=True
    )
    address2 = UserAddress(
        user_id=1, address_id=2,is_primary=False
    )
    address3 = UserAddress(
        user_id=2, address_id=1,is_primary=True
    )
    address4 = UserAddress(
        user_id=3, address_id=2,is_primary=False
    )
